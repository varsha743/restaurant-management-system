    ...
    <aside class="vertical-menu" id="vertical-menu">
        <div>
            <ul class="menu-bar">
                ...
                <li>
                    <a href="inventory.php" class="a-verMenu inventory_link">
                        <i class="far fa-utensils icon-ver"></i>
                        <span style="padding-left:6px;">Inventory</span>
                    </a>
                </li>
                <li>
                    <a href="supplier.php" class="a-verMenu supplier_link">
                        <i class="far fa-user icon-ver"></i>
                        <span style="padding-left:6px;">Suppliers</span>
                    </a>
                </li>
                <div class="dropdown-divider"></div>
                ...
                <li>
                    <a href="staff.php" class="a-verMenu staff_link">
                        <i class="far fa-user icon-ver"></i>
