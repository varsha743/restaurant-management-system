...
<script type="text/javascript">
    ...
    var file_data = $('#add_gallery_imageUpload').prop('files')[0];
    ...
    if($.trim(image_name) == "") {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(data.includes("Great! Image has been inserted successfully")) {
                    setTimeout(function() {
                        location.reload();
                    }, 2000);
                }
    ...
    $.ajax({
        ...
        success: function(data) {
            if(data.trim() === "success") {
                ...
                swal("Error", "An error occurred while deleting the image", "error");
                console.log("Server response:", data);
            }
        },
        error: function(xhr, status, error) {
            swal("Error", "Failed to delete the image: " + error, "error");
        }
    });
});
